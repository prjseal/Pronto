...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "49fe6be6f2761b44")]
...
#pragma warning restore 0109
	...
	/// <summary>Pronto Dashboard</summary>
	[PublishedContentModel("prontoDashboard")]
	public partial class ProntoDashboard : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "prontoDashboard";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ProntoDashboard(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProntoDashboard, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		///<summary>
		/// Useful Links: Add some useful links to show on the dashboard when logging into Umbraco
		///</summary>
		[ImplementPropertyType("usefulLinks")]
		public IEnumerable<IPublishedContent> UsefulLinks
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("usefulLinks"); }
		}
	}

	/// <summary>Pronto Link Item</summary>
	[PublishedContentModel("prontoLinkItem")]
	public partial class ProntoLinkItem : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "prontoLinkItem";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ProntoLinkItem(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProntoLinkItem, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		///<summary>
		/// Link Url: Enter a url for the link
		///</summary>
